...
[[ "${MAIN_REFUND_SETTING,,}" == "false" ]] ||
	die "$SOURCE_CONTAINER must have CAMPAIGN_REFUND_RECONCILIATION_SCHEDULER_ENABLED=false (found: ${MAIN_REFUND_SETTING:-unset})"
...
CAMPAIGN_REFUND_RECONCILIATION_SCHEDULER_ENABLED=true
