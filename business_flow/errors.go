...
var (
	...
	ErrSmartTargetingExecutionCalculationRequired = errors.New("a ready execution audience calculation is required")
	ErrSmartTargetingExecutionCalculationStale    = errors.New("the execution audience calculation is stale")
